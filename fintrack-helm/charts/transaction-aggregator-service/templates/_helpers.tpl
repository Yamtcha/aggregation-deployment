...
Common labels
*/}}
{{- define "transaction-aggregator-service.labels" -}}
...
*/}}
{{- define "transaction-aggregator-service.image" -}}
...
*/}}
{{- define "transaction-aggregator-service.initContainers" -}}
...
*/}}
{{- define "transaction-aggregator-service.rabbitmqEnv" -}}
- name: RABBITMQ_HOST
  valueFrom:
    secretKeyRef:
